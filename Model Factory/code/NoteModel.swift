...
//  NoteModel.swift
//
//  Generated by Notenik on 2020-07-27
//
...
final class NoteModel: Model {
    ...
    init(id: UUID? = nil,
    	title: String     	titleSort: String     	titleCommon: String     	slug: String     	seq: String     	seqSort: String     	date: String     	dateSort: String     	status: String     	statusSort: String     	statusDone: String     	tags: String     	link: String     	author: String     	authorSort: String     	teaser: String     	teaserHtml: String     	body: String     	bodyHtml: String ) 
	{
		self.id = id
    	self.title = title
